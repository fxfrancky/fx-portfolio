    ...
    <div className={`w-full h-full  ${props.darkMode ? "dark" : ""}`}>
      <div className="dark:bg-gray-800">
        <motion.div
          ...
          className="section bg-ghostWhite dark:bg-gray-800"
          id="contact"
        >
          <div className="mb-8">
          ...
          <div className="w-full h-screen grid place-items-center bg-ghostWhite dark:bg-gray-800">
