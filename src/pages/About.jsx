          ...
          <div className="hero  pt-24">
            <div className="hero-content flex-col md:flex-row-reverse gap-14 ">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
              >
                <h4 className="text-[1.5rem] md:text-2xl font-semibold dark:text-ghostWhite">
                  Here is a{" "}
                  <span className="underline decoration-[#14b8a5]/50">
                    little
                  </span>{" "}
                  background
                </h4>
                <p className="p text-justify dark:text-ghostWhite">
                ...
                <h4 className="text-[1.5rem] md:text-2xl font-semibold py-8 dark:text-ghostWhite">
                  Lets stay in{" "}
                  <span className="underline decoration-[#14b8a5]/50">
                    touch
                  </span>{" "}
                ...
                {/* Socials Section */}
                <div className="text-4xl flex gap-8 sm:gap-14 py-3 text-gray-600 dark:text-gray-400">
                  <a
